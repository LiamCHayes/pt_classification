...
A measurement that captures how clear and high variance a signal is the amplitude of a sin regression. A sin regresison will fit with a higher amplitude when signals are clearer and variance is higher. 
...
Here is a graph of the same series with a spline fit to it:

****Insert plot2 here****

Here is a graph of the original series compared to the detrended series:
