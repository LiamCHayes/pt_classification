...
tSesh %>% ggplot() +
  ...
  labs(x='Time Index', y='Acceleration in the x Direction', title='Session 1, Exercise 1, Sensor 2, Acceleration (x)')
```
...
p %>%
  ...
  labs(title='Session 1, Exercise 1, Sensor 2, Acceleration',
       y='Acceleration',
       x='Time Index') +
...
tSesh_all_sensors %>%
  ggplot() +
  geom_line(aes(x=time.index, y=acc1), col='orange', ) +
  geom_line(aes(x=time.index, y=acc2), col='dodgerblue', ) +
  geom_line(aes(x=time.index, y=acc3), col='red2', ) +
  geom_line(aes(x=time.index, y=acc4), col='green2', ) +
  geom_line(aes(x=time.index, y=acc5), ) +
  facet_grid(coord~., scales='free') +
